...
const vcard = 'BEGIN:VCARD\n' //jangan ganti Sayang
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285230628605:+6285230628605\n'  //ganti nomor kamu sayang
...
namabot = '🌺abw-bot🌺' //ganti nama bot kamu
cr = '🌺abw-bot🌺' //ganti nama bot
faketoko = "🌺abw-bot🌺" //ganti nama bot
lolkey = 'e3d6805ea05cefd5b8fc3a9c' //apiknya ya sayang
zeksapi = 'abw-ApiKey' //free apikey
/******** OWNER NUMBER**********/

const ownerNumber = ["6285230628605@s.whatsapp.net"]   //ganti nomor kamu sayang
...
client.version = [2, 2119, 6]
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('abw','red'),color('X','lime'),color('LolHuman','red'))
})
	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
           	const ftoko = { key: { fromMe: false, participant: `6285230628605@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `🌺abw🌺`, "productImageCount": 9999 }, "businessOwnerJid": `6285230628605@s.whatsapp.net`}}}
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 𝐀𝐍𝐓𝐈 𝐁𝐀𝐃𝐖𝐎𝐑𝐃 」*\nBotz 🌺abw-bot🌺 akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
                        }).catch(() => client.sendMessage(from, `Untung Botz 🌺abw-bot🌺 bukan admin, kalo admin udah Botz kick!`, text , {quoted : mek}))
                } else {
...
/**************** FAKE SETTING ******************/
const btrai = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*🌺abw🌺*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('src/abwmeme/abw.jpeg')} } }
const fharga = { key: {
			fromMe: false,
		...
		message: {
			"productMessage": {
				"product": {
					"productImage":{
						"mimetype": "image/jpeg",
						"jpegThumbnail": fs.readFileSync('src/abwmeme/abw.jpeg')
					},
					"title": faketoko,
...
client.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
		...
		case 'transfer':
				...
				if (!q.includes('|')) return  reply(ind.wrongf())
                		...
                		addKoinUser('6285230628605@s.whatsapp.net', fee)
...
case 'addbadword':
		...
		case 'giftlimit': 
				...
				const nomerr = args[0].replace('@','')
                		...
                		if (!nomerr) return reply(`maaf format salah\nmasukan parameter yang benar\ncontoh : ${prefix}giftlimit @6285230628605`)
...
│๖ۣ•҉ 𝐘𝐎𝐔𝐓𝐔𝐁𝐄 : ARI BAGUS WIDYANTORO ?
╰────────────────⊱
╭──>
╰────────────────⊱
╭──❲ 𝐈𝐍𝐅𝐎 𝐏𝐄𝐍𝐆𝐆𝐔𝐍𝐀 ❳
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6285230628605@s.whatsapp.net', options, text, {quoted: mek})
					reply('Masalah telah di laporkan ke owner 🌺abw🌺 Laporan palsu atau main² tidak akan ditanggapi.')
					break
					case 'antidelete':
		...
		case 'request':
					...
					client.sendMessage('6285230628605@s.whatsapp.net', options, text, {quoted: fharga})
					client.sendMessage('6285230628605@s.whatsapp.net', options, text, {quoted: fharga})
					client.sendMessage('6285230628605@s.whatsapp.net', options, text, {quoted: fharga})
...
if (args.length == 0) return reply(`Idnya mana kak?`)
		...
		case 'sewabot':
		wibu = fs.readFileSync(`./mp3/wibu.mp3`)
		wew = fs.readFileSync(`./src/abw.jpg`)
		                     zain = `
...
➢ 𝟏 𝑩𝒖𝒍𝒂𝒏 : 𝟏𝟓𝑲
➢ 𝑷𝒆𝒓𝒎𝒂𝒏𝒆𝒏 : 𝟐𝟎𝑲
➢ 𝑷𝒆𝒎𝒃𝒂𝒚𝒂𝒓𝒂𝒏 𝑩𝒊𝒔𝒂 𝑴𝒆𝒍𝒂𝒍𝒖𝒊 : Dana
➢ 𝑺𝒊𝒔𝒕𝒆𝒎 𝑺𝒆𝒘𝒂 𝑩𝒐𝒕 : 𝑴𝒂𝒔𝒖𝒌 𝑮𝒄 𝑳𝒖𝒉 - 𝑱𝒂𝒅𝒊𝒊𝒏 𝑨𝒅𝒎𝒊𝒏 - 𝑻𝒇 - 𝑫𝒐𝒏𝒆
──────────────────────────────
➢ 𝑪𝒓𝒆𝒂𝒕𝒐𝒓 𝑩𝒐𝒕𝒛 𝑶𝒇𝒇𝒊𝒄𝒊𝒂𝒍 : *https://github.com/Abwhost123*
──────────────────────────────
➢ 𝒀𝒐𝒖𝒕𝒖𝒃𝒆 : *_ARI BAGUS WIDYANTORO*
──────────────────────────────
...
break
		...
		case 'group':
            ...
            case 'developer':
                  ...
                  client.sendMessage(from, '𝐓𝐮𝐡 𝐍𝐨𝐦𝐨𝐫 𝐎𝐰𝐧𝐞𝐫 🌺abw🌺 , 𝐄𝐦𝐚𝐧𝐠 𝐋𝐮𝐡 𝐌𝐚𝐮 𝐀𝐩𝐚 𝐂𝐡𝐚𝐭 𝐎𝐰𝐧𝐞𝐫 𝐆𝐮𝐚 ? ',MessageType.text, { quoted: mek} )
                  client.sendMessage(from, duingz, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true} )
					break    
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
		...
		case 'kick':
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('Tag yang ingin di tendang')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
...
//MAKERMENU
                ...
                case 'thunder':
		if (!isRegistered) return reply(ind.noregis())
                     if (args.length == 0) return reply(`Teks Mana Om? Contoh ${prefix + command} created : 🌺abw🌺 ?`)
	                reply(ind.wait())
                    ini_txt = args.join(" ")
        ...
        if (!isRegistered) return reply(ind.noregis())
         ...
         if (!isRegistered) return reply(ind.noregis())
          ...
          if (!isRegistered) return reply(ind.noregis())
                    ...
                    case 'neon':
		if (!isRegistered) return reply(ind.noregis())
                     if (args.length == 0) return reply(`Teks Mana Om? Contoh ${prefix + command} creator : 🌺abw🌺 ?`)
	                reply(ind.wait())
...
//DOWNLOAD MENU
		...
		if (budy.includes(`6285230628605`)) {
